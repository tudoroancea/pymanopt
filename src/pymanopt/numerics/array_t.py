...
__all__ = ["array_t", "SUPPORTED_NUMERICS_BACKENDS", "AVAILABLE_NUMERICS_BACKENDS"]

SUPPORTED_NUMERICS_BACKENDS = ["numpy", "pytorch", "jax", "tensorflow"]
AVAILABLE_NUMERICS_BACKENDS = ["numpy"]

array_t = int | float | list | tuple | np.ndarray | None
...
try:
    ...
    array_t = array_t | jax.numpy.ndarray
except ImportError:
    pass
